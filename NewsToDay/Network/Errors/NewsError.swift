...
// MARK: - Cases for bookmarks
    case unableToBookmark = "There was an error bookmarking this post. Please try again"
    case alreadyBookmarked = "You've already bookmarked this post!"
}
